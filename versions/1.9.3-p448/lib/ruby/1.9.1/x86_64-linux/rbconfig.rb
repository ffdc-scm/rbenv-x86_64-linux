...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/root/.rbenv/versions/1.9.3-p448")
  ...
  CONFIG["configure_args"] = " '--prefix=/root/.rbenv/versions/1.9.3-p448' 'LDFLAGS=-L/root/.rbenv/versions/1.9.3-p448/lib ' 'CPPFLAGS=-I/root/.rbenv/versions/1.9.3-p448/include '"
  ...
  CONFIG["cppflags"] = "-I/root/.rbenv/versions/1.9.3-p448/include "
  CONFIG["NULLCMD"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/root/.rbenv/versions/1.9.3-p448/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/root/.rbenv/versions/1.9.3-p448/lib  -rdynamic -Wl,-export-dynamic"
